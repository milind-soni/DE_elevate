...
import pytest
from source_rockset.source import RocksetStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RocksetStream, "path", "v0/example_endpoint")
    mocker.patch.object(RocksetStream, "primary_key", "test_primary_key")
    mocker.patch.object(RocksetStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = RocksetStream()
